...
public class QUserMission extends EntityPathBase<UserMission> {
    ...
    private static final long serialVersionUID = -1193790600L;
    ...
    public final com.example.spring_boot_a.domain.entity.etc.QMission mission;
    ...
    public QUserMission(Class<? extends UserMission> type, PathMetadata metadata, PathInits inits) {
        ...
        this.mission = inits.isInitialized("mission") ? new com.example.spring_boot_a.domain.entity.etc.QMission(forProperty("mission"), inits.get("mission")) : null;
